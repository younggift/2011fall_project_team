...
public class MainClient extends JFrame implements ActionListener,Runnable,MouseListener
{
    ...
    ArrayList PlayCard1=new ArrayList();//记录上个玩家出牌
    ArrayList PlayCard2=new ArrayList();//记录上一个玩家出牌
    public static ArrayList RecordCard=new ArrayList();//记录玩家出牌
    ArrayList LeftCard=new ArrayList();//记录剩下的牌
